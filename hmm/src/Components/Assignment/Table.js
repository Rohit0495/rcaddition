...
export default function Table() {
  ...
  const [RowTotal, setTotal] = useState(
    OneOne +
      OneTwo +
      OneThree +
      TwoOne +
  ...
  const RemoveRowTwoSum = () => {
    ...
    total =
      total +
      (+OneOne + +OneTwo + +OneThree + +ThreeOne + +ThreeTwo + +ThreeThree);
    setTwoOne("");
    setTwoTwo("");
    setTwoThree("");
    setTotal("");
  ...
  const RemoveRowThreeSum = () => {
    let total = 0;
    total =
      total + (+TwoOne + +TwoTwo + +TwoThree + +OneOne + +OneTwo + +OneThree);
    setThreeOne("");
    setThreeTwo("");
    setThreeThree("");
    setTotal("");
      ...
      <table className="styled-table">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <button className="button" onClick={RemoveRowOneSum}>
                Delete
              </button>{" "}
              <br />{" "}
            </td>
          ...
          <tr>
            ...
            <td>
              <button className="button" onClick={RemoveRowTwoSum}>
                Delete
              </button>{" "}
              <br />{" "}
            </td>
          ...
          <tr>
            ...
            <td>
              <button className="button" onClick={RemoveRowThreeSum}>
                Delete
              </button>{" "}
              <br />{" "}
            </td>
        ...
        <tfoot>
          <tr>
            <button className="button" onClick={TotalSum}>
              Total Sum
            </button>{" "}
            {RowTotal}{" "}
          </tr>
